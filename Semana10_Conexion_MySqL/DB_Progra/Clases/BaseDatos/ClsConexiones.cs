...
namespace DB_Progra.Clases.BaseDatos
{
    public class ClsConexiones
    {
        ...
        public ClsConexiones()
        {
            ...
            _conexion = "server = 127.0.0.1; database = progra1; Uid= root; Password= ClunaA2001";
                //"Data Source=DESKTOP-BGUASD0;Initial Catalog=progra1;Integrated Security=True";
